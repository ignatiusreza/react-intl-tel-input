...
describe('TelInput', function () { // eslint-disable-line func-names
  ...
  it('handleKeyUp', () => {
    ...
    subject.update();
    expect(subject.find(TelInput).props().value).toBe('0999 123 45');
  });
  ...
  it('Disabled nationalMode and input phone number', () => {
    ...
    subject.find(TelInput).simulate('change', { target: { value: '+886901234567' } });
    subject.update();
    expect(subject.find(TelInput).props().value).toBe('+886901234567');
  });
  ...
  describe('uncontrolled', () => {
    ...
    it('should change value', () => {
      ...
      subject.find(TelInput).simulate('change', { target: { value: '12345' } });
      subject.update();
      expect(subject.find(TelInput).props().value).toBe('12345');
    ...
    it('should change props value', () => {
      ...
      subject.update();
      expect(subject.find(TelInput).props().value).toBe('+886912345678');
    });
  });
});
